...
type Client struct {
	...
	ThreadConfig map[string]interface{} `bson:"thread_config,omitempty" json:"thread_config,omitempty"`
	ChatConfig   map[string]interface{} `bson:"chat_config,omitempty" json:"chat_config,omitempty"`
}
